...
* Adds a button to the Windows browser toolbar. When clicked, it sends the URL of the current tab to **[Archive Today](https://archive.today)** to preserve a snapshot of the page, and opens the result in a new tab.
* Also includes Link context menu to Archive or Search, Page context menu to Search. 
* On Android, extension now has a popup menu to choose Archive or Search.
...
◦ Add Options button to Android action tab for full feature access.   
◦ Removed redundant optional notification.
* 1.4.4: Add desktop toolbar icon options for dropdown menu (default) and direct Search.
* 1.3.0: Enhanced Android with action tab to enable Search in addition to Archive.
