...
* **NEW: Customizable Toolbar Button**: Choose your preferred action for the toolbar icon on Desktop:
...
* **Archive Today Integration**: Sends the current tab URL to **[Archive Today](https://archive.today)** to preserve a snapshot and opens the result in a new tab.
* **Context Menus**: Includes Link context menu to Archive or Search, and a Page context menu to Search.
* **HTTPS Security**: Uses HTTPS for all archival and search transmissions.
* **Android™ Support**: Fully optimized for mobile with a dedicated action menu.
